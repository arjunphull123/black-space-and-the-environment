...
//Factor explanations:
let expl = {
  'Asthma': 'Asthma is a chronic (long-term) condition that affects the airways in the lungs. The airways are tubes that carry air in and out of your lungs. If you have asthma, the airways can become inflamed and narrowed at times. This makes it harder for air to flow out of your airways when you breathe out. Approximately 25 million people in the U.S. have asthma. This equals about 1 in 13 people. About 20 million U.S. adults age 18 and older have asthma. Asthma rates are highest in Black adults in the U.S.',
  'COPD': 'COPD, or chronic obstructive pulmonary disease, is a progressive disease, which means it gets worse over time. With COPD, less air flows in and out of the airways, making it hard to breathe. COPD is a major cause of disability, and it is the fourth leading cause of death in the United States according to the Centers for Disease Control and Prevention (CDC).',
  'Lung Cancer': 'Lung cancer is cancer that forms in tissues of the lung, usually in the cells that line the air passages. There are two main types: small cell lung cancer and non-small cell lung cancer. These two types grow differently and are treated differently. Non-small cell lung cancer is the more common type. Lung cancer is by far the leading cause of cancer death in the US, accounting for about 1 in 5 of all cancer deaths. Each year, more people die of lung cancer than of colon, breast, and prostate cancers combined.',
  'Cardiovascular': 'Cardiovascular disease is a group of diseases affecting your heart and blood vessels. These diseases can affect one or many parts of your heart and/or blood vessels. Cardiovascular disease is the leading cause of death worldwide and in the U.S. Almost half of adults in the U.S. have some form of cardiovascular disease. It affects people of all ages, sexes, ethnicities and socioeconomic levels. One in three women and people assigned female at birth dies from cardiovascular disease.',
...
const options = document.querySelectorAll(".options-group button");
